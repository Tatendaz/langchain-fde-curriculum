# After the curriculum, and what to read

Linked from the README's [curriculum table](../README.md#the-curriculum).
...
- **Official docs** — [LangChain](https://docs.langchain.com/oss/python/langchain/overview),
